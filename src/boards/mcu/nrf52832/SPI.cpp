...
// void SPIClass::begin(NRF_SPI_Type *p_spi, uint8_t uc_pinMISO, uint8_t uc_pinSCK, uint8_t uc_pinMOSI)
// {
//     Serial.printf("SPIClass begin with MISO %d SCLK %d MOSI %d\n", uc_pinMISO, uc_pinSCK, uc_pinMOSI);
//   _p_spi = p_spi;
...
//   Serial.printf("SPIClass begin with _uc_pinMiso %d _uc_pinSCK %d _uc_pinMosi %d\n", _uc_pinMiso, _uc_pinSCK, _uc_pinMosi);
